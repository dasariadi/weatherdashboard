// let us define the api key and variables first
// This is our API key.
var APIKey = "&appid=7d2be55cfbda8f574a40ec7dd57fc06c";
...
function citySearch(city) {
	...
	$.ajax({
		...
		// line two
		//   * Temperature
		// I am also converting it into celcius because who can read kelvins?!
		console.log(response.main.temp);
		var K = response.main.temp;
		console.log(K);
		var C = ((K - 273.15)).toFixed(0);
		console.log(C);
